...
typedef struct Segment
{
	...
	Scalar color;
	int area;
	Point up_left;//bounding box
	Point low_right;//bounding box
public:
	Segment(){ID=0;color=Scalar(0);area=0;up_left=low_right=Point(0,0);};
}Segment;
...
inline bool isIdentical(Point a,Point b,BwImage_ img);
